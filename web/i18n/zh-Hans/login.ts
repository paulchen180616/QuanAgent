const translation = {
  ...
  license: {
    tip: '启动 QuanAgent 之前，请阅读 GitHub 上的',
    link: '开源协议',
  },
  join: '加入 ',
  joinTipStart: '邀请你加入 ',
  ...
  licenseExpiredTip: '您所在空间的许可证已过期，请联系管理员。',
  licenseLost: '许可证丢失',
  licenseLostTip: '无法连接许可证服务器，请联系管理员。',
  licenseInactive: '许可证未激活',
  licenseInactiveTip: '许可证尚未激活，请联系管理员。',
  webapp: {
    login: '登录',
