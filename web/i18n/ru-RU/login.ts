const translation = {
  ...
  license: {
    tip: 'Перед запуском QuanAgent ознакомьтесь с лицензией GitHub',
  ...
  licenseInactiveTip: 'Лицензия Enterprise для рабочего пространства неактивна. Обратитесь к своему администратору, чтобы продолжить использование Dify.',
  licenseExpiredTip: 'Срок действия лицензии Enterprise для рабочего пространства истек. Обратитесь к своему администратору, чтобы продолжить использование Dify.',
  webapp: {
