const translation = {
  ...
  license: {
    tip: 'Перед запуском QuanAgent ознайомтеся з ліцензією з відкритим кодом на GitHub',
  ...
  licenseInactiveTip: 'Ліцензія Enterprise для вашої робочої області неактивна. Будь ласка, зверніться до свого адміністратора, щоб продовжити користуватися Dify.',
  licenseExpiredTip: 'Термін дії ліцензії Enterprise для вашого робочого простору закінчився. Будь ласка, зверніться до свого адміністратора, щоб продовжити користуватися Dify.',
  webapp: {
