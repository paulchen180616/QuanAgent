const translation = {
  ...
  license: {
    tip: 'QuanAgent\'ı başlatmadan önce GitHub\'daki',
  ...
  back: 'Geri',
  licenseExpiredTip: 'Çalışma alanınız için Enterprise lisansının süresi doldu. Dify\'ı kullanmaya devam etmek için lütfen yöneticinizle iletişime geçin.',
  ...
  licenseInactiveTip: 'Çalışma alanınız için Enterprise lisansı etkin değil. Dify\'ı kullanmaya devam etmek için lütfen yöneticinizle iletişime geçin.',
