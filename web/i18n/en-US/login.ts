const translation = {
  ...
  license: {
    tip: 'Before starting QuanAgent, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join ',
  joinTipStart: 'Invite you join ',
  joinTipEnd: ' team on QuanAgent',
  invalid: 'The link has expired',
  explore: 'Explore QuanAgent',
  ...
  licenseExpiredTip: 'The Enterprise license for your workspace has expired. Please contact your administrator to continue using Dify.',
  ...
  licenseInactiveTip: 'The Enterprise license for your workspace is inactive. Please contact your administrator to continue using Dify.',
  webapp: {
    login: 'Login',
